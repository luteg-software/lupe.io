...
/**
 ...
 @param connector Luteg Connector Object
 @param sessionId Session ID of the user
 @param error nil if no error exists
 */
...
/**
 Fired when joined to a room

 @param connector connector object
 @param roomName room name
 @param clients client array in the room
...
/**
 Fired when client joined to a room
 
 @param connector connector object
 @param client room name
 @param sessionName client array in the room
 */
- (void)connector:(LTGConnector *)connector clientJoined:(LTGClient *)client sessionName:(NSString *)sessionName {
    [self.usersTableView reloadData];
}
/**
 Fired when client left to a room
...
/**
 Call functions within tableviewcell select
 */
...
/**
 When a client wihin room calls

 @param client caller
 @param confirmationMessage incoming call confirmation message
 @param accept call for accepting the call
 @param decline call for declining
 */
...
/**
 When data channel opens, this function is called

 @param client remote client object
 @param channelName channel name for data
 @param isRemote is true when request recieved from remote peer
 @param error nil if no error
 */
